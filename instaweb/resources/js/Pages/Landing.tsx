...
const FEATURES = [
    ...
    { icon: '🌐', title: 'Publicación automática',   desc: 'Elige un dominio propio o usa tu subdominio en twtyg.com. El sitio queda online en segundos tras el pago.' },
...
const TESTIMONIALS = [
    ...
    { name: 'Marcos T.', role: 'Emprendedor',            text: 'Puse mi landing de SaaS en producción el mismo día que tuve la idea. Con Wix tardé semanas. Con Twtyg, horas.', avatar: 'M', color: 'from-cyan-500 to-blue-500' },
];

const COMPARE = [
    { feature: 'Generación por IA',           twtyg: true,        wix: false,       ss: false,     webflow: false  },
    { feature: 'Editor de código real',        twtyg: true,        wix: false,       ss: false,     webflow: true   },
    { feature: 'Precio desde',                 twtyg: '6,99€/mes', wix: '13€/mes',   ss: '16€/mes', webflow: '14€/mes' },
    { feature: 'Subdominio gratis',            twtyg: true,        wix: true,        ss: false,     webflow: false  },
    { feature: 'SSL incluido',                 twtyg: true,        wix: true,        ss: true,      webflow: true   },
    { feature: 'Sin comisiones',               twtyg: true,        wix: false,       ss: false,     webflow: true   },
    { feature: 'Soporte en español',           twtyg: true,        wix: true,        ss: false,     webflow: false  },
    { feature: 'Cambios por lenguaje natural', twtyg: true,        wix: false,       ss: false,     webflow: false  },
];
...
export default function Landing() {
    ...
    return (
        <>
            <Head>
                <title>Twtyg — The web that you get | Crea tu web con IA</title>
                <meta name="description" content="Twtyg crea tu web profesional con IA en segundos. Describe tu negocio, edita con código real y publica con tu dominio. Desde 6,99€/mes. 7 días gratis." />
                <meta name="keywords" content="crear web con IA, constructor web inteligencia artificial, diseño web automático, twtyg" />
                <meta property="og:title" content="Twtyg — The web that you get" />
                <meta property="og:description" content="Crea tu web profesional con IA en segundos. Sin código. Sin diseñador." />
                <meta property="og:type" content="website" />
                <link rel="canonical" href="https://twtyg.com" />
            </Head>
            ...
            <div className="bg-gray-950 text-white min-h-screen">
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {[
                                ...
                                { n: '03', icon: '🚀', title: 'Publica y listo',      desc: 'Subdominio gratis en twtyg.com o tu propio .com. Online en segundos, completamente automático.' },
                            ].map(step => (
                ...
                <section className="py-24 px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-4xl font-black mb-3">¿Por qué Twtyg?</h2>
                            ...
                            <table className="w-full text-sm">
                                <thead>
                                    <tr className="border-b border-gray-800">
                                        ...
                                        <th className="py-4 px-5 text-violet-300 font-bold text-center">twtyg</th>
                                ...
                                <tbody>
                                    {COMPARE.map((row, i) => (
                                        <tr key={row.feature} className={i % 2 === 0 ? 'bg-gray-900/30' : ''}>
                                            ...
                                            <td className="py-3.5 px-5 text-center"><Cell val={row.twtyg} /></td>
                ...
                <section ref={pricingRef} id="precios" className="py-24 px-6 bg-gray-900/40 border-y border-gray-800/50">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
                                ...
                                <ul className="space-y-2.5 text-sm text-gray-300 mb-8">
                                    {['3 proyectos activos', 'IA ilimitada', 'Subdominio en twtyg.com', 'Editor de código', 'SSL incluido', 'Soporte por email'].map(f => (
                            ...
                            <div className="bg-gradient-to-b from-violet-950/50 to-gray-900 border border-violet-700/60 rounded-2xl p-8 relative shadow-2xl shadow-violet-950/30">
                                ...
                                <ul className="space-y-2.5 text-sm text-gray-300 mb-8">
                                    {['Proyectos ilimitados', 'IA ilimitada', 'Dominio propio incluido (.com)', 'Editor avanzado', 'SSL incluido', 'Soporte prioritario', 'Analytics básico', 'Sin publicidad de Twtyg'].map(f => (
                                        <li key={f} className="flex items-center gap-2">
                                            <span className="text-green-400 text-xs font-bold">✓</span>{f}
                                        </li>
                                    ))}
                        ...
                        <p className="text-center text-sm text-gray-600 mt-8">
                            ¿Necesitas más? <a href="mailto:hola@twtyg.com" className="text-violet-400 hover:underline">Escríbenos</a> para un plan a medida.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="max-w-2xl mx-auto">
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                { q: '¿Puedo usar mi propio dominio?',       a: 'Sí. En el plan Pro incluimos la compra y configuración automática de un dominio .com. También puedes usar un subdominio gratuito en twtyg.com.' },
                ...
                <footer className="border-t border-gray-800 py-10 px-6">
                    <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-gray-600">
                        <div className="flex items-center gap-2">
                            <span className="font-black text-lg bg-gradient-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent">twtyg</span>
                        ...
                        <div className="flex gap-6">
                            ...
                            <a href="mailto:hola@twtyg.com" className="hover:text-gray-400 transition-colors">Contacto</a>
                        </div>
                        <p>© {new Date().getFullYear()} Twtyg · Todos los derechos reservados</p>
                    </div>
                </footer>
            </div>
        </>
