...
- ✅ **Fix race condition en AiRateLimit** (TOCTOU): `reserve()` atómica impide que dos peticiones concurrentes pasen el check de cuota simultáneamente y la sobrepasen. Suite 100/100 verde.
