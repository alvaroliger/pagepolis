...
- ✅ **Email de bienvenida post-registro** con CTA a /crear (WelcomeMail + ShouldQueue listener, 5 tests).
...
- Email de bienvenida al registrarse con CTA a /crear (PR #5, 101/101 tests).
