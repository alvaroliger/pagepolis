...
<title>Página no encontrada · Pagepolis</title>
<style>
  ...
  <div class="card">
    <a href="/" class="logo-row">
      <svg width="30" height="30" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="pp-grad-404" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stop-color="#8b5cf6" />
            <stop offset="50%" stop-color="#d946ef" />
            <stop offset="100%" stop-color="#06b6d4" />
          </linearGradient>
        </defs>
        <rect x="2" y="2" width="32" height="32" rx="9" fill="url(#pp-grad-404)" />
    ...
    <p>Puede que el enlace esté mal escrito, o que la web a la que apuntaba ya no esté disponible.</p>
    <div class="actions">
